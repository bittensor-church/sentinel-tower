    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["block_number", "netuid"], name="core_setwei_block_n_d7074c_idx"),
                    models.Index(fields=["netuid", "address"], name="core_setwei_netuid_ff1213_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-block_number"],
                "indexes": [
                    models.Index(fields=["block_number", "netuid"], name="core_hyperp_block_n_3a854c_idx"),
                    models.Index(fields=["call_function", "netuid"], name="core_hyperp_call_fu_ccbb3f_idx"),
                ],
            },
        ),
    ]
