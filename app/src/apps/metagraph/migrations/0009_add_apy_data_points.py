...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.DecimalField(decimal_places=0, default=0, help_text='Net alpha dividends this epoch in rao (AlphaDividendsPerSubnet, index 71)', max_digits=30),
        ),
        migrations.AddField(
            model_name='neuronsnapshot',
            name='tao_dividends',
            field=models.DecimalField(decimal_places=0, default=0, help_text='Net TAO dividends this epoch in rao', max_digits=30),
        ),
        migrations.AddField(
            model_name='subnet',
            name='moving_price',
